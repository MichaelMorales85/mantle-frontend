...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-blue-600 text-white">
      ...
      <p className="text-lg mb-8 text-gray-100 text-center max-w-md">
        Secure and verify your vaccination records with MedBadge. Connect your wallet to get started.
      </p>
      {!walletAddress && (
        <button
          className="px-8 py-3 bg-green-500 hover:bg-green-600 text-white font-bold rounded-full shadow-lg transform transition-transform duration-300 hover:scale-105"
